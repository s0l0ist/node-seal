...
describe('GaloisKeys', () => {
  ...
  test('It should assign', () => {
    const realKey = keyGen.createGaloisKeys()
    const emptyKey = new seal.GaloisKeys()
  ...
  test('It should save / load from base64 string', () => {
    const key1 = keyGen.createGaloisKeys()
    const key2 = new seal.GaloisKeys()
