...
describe('PlainText', () => {
  ...
  test('It should reserve memory', () => {
    ...
    expect(plainText.capacity).toEqual(encoder.slotCount * 2)
  })
  test('It should shrink', () => {
    ...
    expect(plainText.capacity).toEqual(encoder.slotCount)
  })
  test('It should release allocated memory', () => {
    ...
    plainText.release()
    expect(spyOn).toHaveBeenCalledWith()
    expect(plainText.scale).toEqual(1)
    expect(plainText.isZero).toEqual(true)
    expect(plainText.capacity).toEqual(0)
  })
  ...
  test('It should return false if plaintext is not zero', () => {
    ...
    const plainText = PlainTextObject()
    encoder.encode(arr, plainText)
    expect(plainText.isZero).toEqual(false)
  })
  ...
  test('It should return the coeff count', () => {
    ...
    const plainText = PlainTextObject()
    encoder.encode(arr, plainText)
    expect(plainText.coeffCount).toEqual(encoder.slotCount)
  })
  test('It should return the significant coeff count', () => {
    ...
    const plainText = PlainTextObject()
    encoder.encode(arr, plainText)
    expect(plainText.significantCoeffCount).toEqual(1)
  })
  test('It should return the non-zero coeff count', () => {
    ...
    const plainText = PlainTextObject()
    encoder.encode(arr, plainText)
    expect(plainText.nonzeroCoeffCount).toEqual(1)
  })
  ...
  test('It should not be in NTT form (bfv)', () => {
    ...
    const plainText = PlainTextObject()
    encoder.encode(arr, plainText)
    expect(plainText.isNttForm).toEqual(false)
  })
  test('It should be in NTT form (ckks)', () => {
    ...
    expect(plainText.isNttForm).toEqual(true)
  })
  test('It should return the scale (ckks)', () => {
    ...
    const plainText = PlainTextObject()
    ckksEncoder.encode(arr, Math.pow(2, 20), plainText)
    expect(plainText.scale).toEqual(Math.pow(2, 20))
  })
  ...
  test('It should load from a string (bfv)', () => {
    ...
    expect(newPlainText.save()).toBe(str)
  })
  test('It should load from a string (ckks)', () => {
    ...
    const newPlainText = PlainTextObject()
    const spyOn = jest.spyOn(newPlainText, 'load')
    newPlainText.load(ckksContext, str)
